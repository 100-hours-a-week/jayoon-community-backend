...
public class QPostLike extends EntityPathBase<PostLike> {
    ...
    private static final long serialVersionUID = 1081123701L;
    ...
    public final kr.adapterz.community.user.entity.QUser user;
    ...
    public QPostLike(Class<? extends PostLike> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new kr.adapterz.community.user.entity.QUser(forProperty("user")) : null;
    }
